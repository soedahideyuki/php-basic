...
<body>
  ...
  <p>
    <?php
    echo '1回以上繰り返されている（1文字以上の）英数字が含まれているかどうかを正規表現で検索します。<br>';

    if(preg_match_all('/[A-Za-z0-9]+/',$str ,$results)){ //[A-Za-z0-9]が1回でも繰り返されている
      echo '>検索結果:';
      print_r($results);
    }else{
      echo '>正規表現に一致しませんでした。';
  ...
  <p>
    <?php
    echo '改行以外の1回以上繰り返されている（1文字以上の）文字が含まれているかどうかを正規表現で検索します。<br>';
